						...
						<span class="input-icon">
                            ...
                            <c:if test="${QX.cha == 1 }">
                                ...
                                <td style="vertical-align:top;"><a class="btn btn-mini btn-light"
                                                                   onclick="window.location.href='<%=basePath%>/user/listTabUser';"
...
<script type="text/javascript">
    ...
    function editUser(user_id) {
        ...
        diag.Drag = true;
        diag.Title = "资料";
        diag.URL = '<%=basePath%>user/toEditU?USER_ID=' + user_id;
        diag.Width = 225;
        diag.Height = 415;
        diag.CancelEvent = function () {
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
...
<script type="text/javascript">
    ...
    function toExcel() {
        ...
        window.location.href = '<%=basePath%>user/excel?USERNAME=' + USERNAME + '&lastLoginStart=' + lastLoginStart + '&lastLoginEnd=' + lastLoginEnd + '&ROLE_ID=' + ROLE_ID;
    }
    ...
    function fromExcel() {
        ...
        diag.URL = '<%=basePath%>user/toUploadExcel';
        diag.Width = 300;
        diag.Height = 150;
        diag.CancelEvent = function () {
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
