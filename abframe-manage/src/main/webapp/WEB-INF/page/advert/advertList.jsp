    ...
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                ...
                <!-- 检索  -->
                <form action="adv/list?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm"
                      id="userForm">
                    <table border='0'>
                        <tr>
                            <td>
...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        diag.Drag = true;
        diag.Title = "编辑";
        diag.URL = '<%=basePath%>adv/toEdit?id=' + id;
        diag.Width = 800;
        diag.Height = 650;
        diag.CancelEvent = function () {
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
    ...
    function del(id) {
        bootbox.confirm("确定要删除该记录?", function (result) {
            if (result) {
                var url = "<%=basePath%>adv/delete?id=" + id + "&tm=" + new Date().getTime();
