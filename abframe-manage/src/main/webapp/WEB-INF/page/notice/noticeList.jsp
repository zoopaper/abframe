...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                <!-- 检索  -->
                <form action="notice/list?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm"
                      id="userForm">
                    <table border='0'>
                        <tr>
                            <td>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        diag.Drag = true;
        diag.Title = "新增";
        diag.URL = '<%=basePath%>notice/toAdd';
        diag.Width = 800;
        diag.Height = 600;
    ...
    function edit(id) {
        ...
        diag.Drag = true;
        diag.Title = "编辑";
        diag.URL = '<%=basePath%>notice/toEdit?id=' + id;
        diag.Width = 800;
        diag.Height = 600;
        diag.CancelEvent = function () {
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
    ...
    function del(id) {
        bootbox.confirm("确定要删除该记录?", function (result) {
            if (result) {
                var url = "<%=basePath%>notice/delete?id=" + id + "&tm=" + new Date().getTime();
